...
namespace nunuSnowBalling.Socket {
    public partial class nunuSnowBallingSocket {

        protected static nunuSnowBallingSocket Instance = null;
        public static nunuSnowBallingSocket GetInstance() {
            if (Instance == null) {
                Instance = new nunuSnowBallingSocket();
                Instance.Init();
            }
            return Instance;
        }
