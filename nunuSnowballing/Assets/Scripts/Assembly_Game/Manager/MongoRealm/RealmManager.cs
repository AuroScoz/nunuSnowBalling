...
namespace Service.Realms {
    ...
    public static partial class RealmManager {
        ...
        static Dictionary<EnvVersion, string> REALM_APPID_DIC = new Dictionary<EnvVersion, string>() {
            { EnvVersion.Dev, "nunuSnowBalling-pirlo"},
            { EnvVersion.Test, "nunuSnowBalling-pirlo"},
            { EnvVersion.Release, "nunuSnowBalling-pirlo"},
        };
        public static string DBName { get; private set; } = "nunuSnowBalling";
