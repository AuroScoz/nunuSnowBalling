...
namespace CrashBonus.Main {
    public class PlayerInfoUI : BaseUI {
        ...
        [SerializeField] Text Text_TargetOdds;
        [SerializeField] Slider Slider_TargetOdds;


        List<int> BetTypes;
        public int CurBet { get; private set; }
        public float TargetOdds { get; private set; }
        ...
        public void RefreshTargetOdds() {
            TargetOdds = MyMath.Round(Slider_TargetOdds.value, 2);
            Text_TargetOdds.text = $"{TargetOdds}x";
        }
